...
def train():
    ...
    img_dir = '/root/dataset/ccpd_mix/splits_train_0916'
    ...
    with tf.Session(config=config) as sess:
        ...
        load_weights(sess,'./resnet50.npy')
        print('load pretrained weights resnet50!')
        # saver.restore(sess, './weights0429-sss/lpdr-mix-608450')
        ...
        for epoch in range(1, 1+configs.epochs):
            ...
            saver.save(sess, "pretrained-resnet/lpdr-mix", global_step=global_step)

            if epoch_loss < best_loss:
                saver_best.save(sess, 'pretrained-resnet/lpdr-best-mix')
